        ...
        <div className="container product-page-container m-5">
            <div className="row row-cols-md-2 row-cols-xs-1 m-5">
                ...
                <div className="col-xs-12 col-md-6  product-details-box">
                    ...
                    <p className='lead m-1 text-dark '> <u>Description:</u>  {product&&product.description}</p>
                    <h5 className="lead display-6 m-1 text-dark"><u>Rating:</u>   {product&&product.rating.rate} </h5>
                </div>
            </div>
        </div>
    </div>
